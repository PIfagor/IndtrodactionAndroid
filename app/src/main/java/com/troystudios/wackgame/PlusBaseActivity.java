 ...
 */
public abstract class PlusBaseActivity extends MusicActivity
     ...
     */
    protected abstract void onPlusClientSignIn(String email,String code);
   // protected abstract void onPlusClientSignIn();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlusClient =
                new PlusClient.Builder(this, this, this).setScopes(Scopes.PLUS_LOGIN, Scopes.PROFILE ,"https://www.googleapis.com/auth/userinfo.email").build();
...
//                .addApi(Plus.API, Plus.PlusOptions.builder().build()).addScope(Plus.SCOPE_PLUS_LOGIN).addScope(Plus.SCOPE_PLUS_PROFILE).build();
//        mGoogleApiClient.connect();
    }
...
//        }
        ...
        String code = "the one to rule them all";
        onPlusClientSignIn(email,code);
       // onPlusClientSignIn();
    }
